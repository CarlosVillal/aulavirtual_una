...
<br><br>
    ...
    foreach ($calificacion as $row) {
        ...
        echo '<td><input type="number" name="cal_Quiz1" value="'. $row['cal_Quiz1'].'"/></td>';
        echo '<td><input type="number" name="cal_Quiz2" value="'. $row['cal_Quiz2'].'"/></td>';
        echo '<td><input type="number" name="cal_Proyecto1" value="'. $row['cal_Proyecto1'].'"/></td>';
        echo '<td><input type="number" name="cal_Proyecto2" value="'. $row['cal_Proyecto2'].'"/></td>';
        echo '<td><input type="number" name="cur_NotaFinal" value="'. $row['cur_NotaFinal'].'"/></td>';
